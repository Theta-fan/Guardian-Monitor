#Staking address
$ActiveGnAddress = "0x00000000000000000000000000000" #<--- Enter your Guardian Node staking address here as it appears on the Guardian Node
...
Write-Host " "
Write-Host "Please note the Guardian Monitor is not free software. After a"
Write-Host "40-day trial period you must either buy a license or remove it"
Write-Host "from your computer."
Write-Host " "
